...
// GetAlphasBetas ...
func (f RecurrenceForm) GetAlphasBetas(d []complex128, indexZ int) []ComplexTupla {

	zeroTupla := ComplexTupla{Alpha: complex(0, 0), Beta: complex(0, 0)}
	initialValue := recurrenceFormParams{zeroTupla, []ComplexTupla{zeroTupla}}

	recFunc := NewRecFunc(f.dx, initialValue, func(index int, v IValue) IValue {
